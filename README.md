...
> **Current version:** 2.3.1 — Windows disk analyzer, junk cleaner, visual space map, drive health sentinel, and storage automation tool.
...
# Output: artifacts/installer/StorageMaster-2.3.1-win-x64-Setup.exe
```
