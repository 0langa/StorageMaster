...
> **Version:** 2.1.3 | **Current-state review:** 2026-06-21 | **.NET 8 / WinUI 3 / Windows App SDK 1.6**
...
- **About:** Current app version from informational assembly metadata (`2.1.3`), diagnostics export, update settings
