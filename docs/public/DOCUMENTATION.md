...
> **Version:** 2.0.1 | **Date:** 2026-05-07 | **.NET 8 / WinUI 3 / Windows App SDK 1.6**
...
- **About:** Current app version from informational assembly metadata (`2.0.1` for this release), diagnostics export, update settings
