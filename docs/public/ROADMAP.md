...
> **Current release:** v2.0.1 (2026-05-07) — Drive Health & Storage Sentinel, schema v7 health snapshots, stable/prerelease-safe versioning and release flow, .NET Desktop Runtime setup check, elevated CLI deep-scan worker, the v1.9 Space Map/runtime rollback baseline, the v2 UI foundation, and hotfixes for responsive layout, scan ETA, loading freezes, Duplicates scrolling, Drive Health layout, and Dashboard health-score copy.
