# StorageMaster — v2.0.0 Release Status

> **Baseline:** v2.0.0 (2026-05-07)
> **Status:** stable release implementation. This replaces the older speculative v2 audit.

## What v2 includes

- Stable release versioning: `StorageMasterVersion=2.0.0` for product/display/update semantics and `StorageMasterAssemblyVersion=2.0.0.0` for Windows assembly/file/manifest versions.
...
- WinUI publish and Inno installer build produce `StorageMaster-2.0.0-win-x64-Setup.exe`.
- GitHub release for tag `v2.0.0` is a stable release and includes installer plus `checksums.txt`.
